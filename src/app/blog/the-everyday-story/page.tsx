      ...
      <section className="public-feature">
        ...
        >
          ...
          <p>
            ...
            chocolate chip cookies together, he cracked the eggs, I ran the
            oven, and we gave the extras away. Then friends started asking for
            them. Then friends of friends. Suddenly we weren&apos;t baking a
            batch on Saturdays. We were baking all the time.
          </p>
          <p>
          ...
          <p>
            ...
            somehow got softer and richer at the same time. Jack grabbed a
            second one off the rack and for the first time in weeks, I
            didn&apos;t flinch. That batch became the Everyday, almost
            overnight. It&apos;s the only cookie we make, and the hemp seeds
            have been in every single batch since.
          </p>
          <h2 style={{ fontSize: "1.4rem", margin: "2rem 0 .75rem" }}>
            So what do hemp seeds actually do?
          </h2>
          <p>
          ...
          <ul style={{ lineHeight: 1.62, color: "#173b35", paddingLeft: "1.2rem" }}>
            <li>
          ...
          <p>
            ...
            sugar, chocolate, and joy, and it should be. The hemp seed just
            means our cookie shows up with a little something extra. As a mom,
            that little something turned out to be everything.
          </p>
          <p>Thanks for reading. Now go eat a cookie.</p>
          <p style={{ fontWeight: 700 }}>xo, Julianna</p>
          <p style={{ marginTop: "2.5rem" }}>
            ...
            <Link href="/faq" style={{ color: "#e66113", fontWeight: 700 }}>
              FAQ
            </Link>
            .
          </p>
